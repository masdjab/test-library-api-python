...
class TestApp(TestCase):
  def setUp(self):
    ...
    self.book_obj_sample = Book(1, "Some Title", "Some Description", datetime.datetime(2000, 1, 1))
  ...
  def __invalid_author_params(self):
    return [
      ...
      }, 
      {
        ...
        "data": {"name": "x" * (Author.max_name_length() + 1), "bio": "abc", "birth_date": "xyz"}, 
        "message": "Name too long, max {} chars".format(Author.max_name_length()), 
      }, 
      {
        "desc": "Must fail when bio too long", 
        "data": {"name": "Name 1", "bio": "x" * (Author.max_bio_length() + 1), "birth_date": "xyz"}, 
        "message": "Bio too long, max {} chars".format(Author.max_bio_length()), 
      }, 
      {
  ...
  def __invalid_book_params(self):
    return [
      ...
      }, 
      {
        ...
        "data": {"author_id": 1, "title": "x" * (Book.max_title_length() + 1), "description": "", "publish_date": ""}, 
        "message": "Title too long, max {} chars".format(Book.max_title_length())
      }, 
      {
        "desc": "Must fail when description empty", 
        "data": {"author_id": 1, "title": "  some title  ", "description": "     ", "publish_date": ""}, 
        "message": "Description cannot be empty"
      }, 
      {
        "desc": "Must fail when description too long", 
        "data": {"author_id": 1, "title": "  some title  ", "description": "x" * (Book.max_description_length() + 1), "publish_date": ""}, 
        "message": "Description too long, max {} chars".format(Book.max_description_length())
      }, 
      {
        "desc": "Must fail when publish date empty", 
        "data": {"author_id": 1, "title": "  some title  ", "description": "  a  ", "publish_date": "     "}, 
        "message": "Invalid publish date ''"
      }, 
      {
        "desc": "Must fail when publish date invalid 1", 
        "data": {"author_id": 1, "title": "abc", "description": "def", "publish_date": "pqrs"}, 
        "message": "Invalid publish date 'pqrs'"
      }, 
      {
        "desc": "Must fail when publish date invalid 2", 
        "data": {"author_id": 1, "title": "abc", "description": "def", "publish_date": "2000"}, 
        "message": "Invalid publish date '2000'"
      }, 
      {
        "desc": "Must fail when publish date invalid 2", 
        "data": {"author_id": 1, "title": "abc", "description": "def", "publish_date": "2000-21-10"}, 
